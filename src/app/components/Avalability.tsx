...
//             <ul className="text-gray-700 list-disc list-inside my-2">
...
//             <ul className="text-gray-700 list-disc list-inside mt-2 mb-3">
...
export default function AvailabilitySection() {
  return (
    <section className="bg-gray-200 py-12 px-6" id="availability">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Session Fees & Availability</h2>
